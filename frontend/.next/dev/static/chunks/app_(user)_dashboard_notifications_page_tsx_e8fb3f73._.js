...
function NotificationsPage() {
    ...
    /* 🔔 REAL-TIME LISTENER */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(_s1({
        "NotificationsPage.useEffect": ()=>{
            _s1();
            if (!user) return;
            // Ask permission once
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
                "NotificationsPage.useEffect.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                "NotificationsPage.useEffect.unsubscribe": async (snapshot)=>{
                    const data = snapshot.docs.map({
                        "NotificationsPage.useEffect.unsubscribe.data": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    ...
                    const newUnread = data.find({
                        "NotificationsPage.useEffect.unsubscribe.newUnread": (n)=>!n.read
                    }["NotificationsPage.useEffect.unsubscribe.newUnread"]);
                    if (newUnread) {
                        // 🔊 Sound
                        if (audioRef.current) {
    ...
    }["NotificationsPage.useEffect"], "OD7bBpZva5O2jO+Puf00hKivP7c="), [
        user
    ]);
...
_s(NotificationsPage, "GseZhf3n/VkjffEHUUuvuQNJLRI=", false, function() {
    return [
...
//# sourceMappingURL=app_%28user%29_dashboard_notifications_page_tsx_e8fb3f73._.js.map